...
Header file for Silabs Si102x and Si103x devices.
Copyright (c) 2012 ARM Ltd and ARM Germnay GmbH.
All rights reserved.
-----------------------------------------------------------------------------*/

#ifndef __SI1020_DEFS_H__
#define __SI1020_DEFS_H__
...
SBIT (S0MODE, SFR_SCON0, 7);        /* UART0 Mode                             */
                                    /* Bit6 UNUSED                            */
SBIT (MCE0, SFR_SCON0, 5);          /* UART0 Multi-Processor Communication    */
...
/* P0 0x80 */
#define SFR_P0 0x80
SBIT (P0_7, SFR_P0, 7);             /* Port 0 Bit 7                           */
SBIT (P0_6, SFR_P0, 6);             /* Port 0 Bit 6                           */
SBIT (P0_5, SFR_P0, 5);             /* Port 0 Bit 5                           */
SBIT (P0_4, SFR_P0, 4);             /* Port 0 Bit 4                           */
SBIT (P0_3, SFR_P0, 3);             /* Port 0 Bit 3                           */
SBIT (P0_2, SFR_P0, 2);             /* Port 0 Bit 2                           */
SBIT (P0_1, SFR_P0, 1);             /* Port 0 Bit 1                           */
SBIT (P0_0, SFR_P0, 0);             /* Port 0 Bit 0                           */

/* P1 0x90 */
#define SFR_P1 0x90
SBIT (P1_7, SFR_P1, 7);             /* Port 1 Bit 7                           */
SBIT (P1_6, SFR_P1, 6);             /* Port 1 Bit 6                           */
SBIT (P1_5, SFR_P1, 5);             /* Port 1 Bit 5                           */
SBIT (P1_4, SFR_P1, 4);             /* Port 1 Bit 4                           */
SBIT (P1_3, SFR_P1, 3);             /* Port 1 Bit 3                           */
SBIT (P1_2, SFR_P1, 2);             /* Port 1 Bit 2                           */
SBIT (P1_1, SFR_P1, 1);             /* Port 1 Bit 1                           */
SBIT (P1_0, SFR_P1, 0);             /* Port 1 Bit 0                           */

/* P2 0xA0 */
#define SFR_P2 0xA2
SBIT (P2_7, SFR_P2, 7);             /* Port 2 Bit 7                           */
SBIT (P2_6, SFR_P2, 6);             /* Port 2 Bit 6                           */
SBIT (P2_5, SFR_P2, 5);             /* Port 2 Bit 5                           */
SBIT (P2_4, SFR_P2, 4);             /* Port 2 Bit 4                           */
SBIT (P2_3, SFR_P2, 3);             /* Port 2 Bit 3                           */
SBIT (P2_2, SFR_P2, 2);             /* Port 2 Bit 2                           */
SBIT (P2_1, SFR_P2, 1);             /* Port 2 Bit 1                           */
SBIT (P2_0, SFR_P2, 0);             /* Port 2 Bit 0                           */

/* P3 0xB0 */
#define SFR_P3 0xB0
SBIT (P3_7, SFR_P3, 7);             /* Port 3 Bit 7                           */
SBIT (P3_6, SFR_P3, 6);             /* Port 3 Bit 6                           */
SBIT (P3_5, SFR_P3, 5);             /* Port 3 Bit 5                           */
SBIT (P3_4, SFR_P3, 4);             /* Port 3 Bit 4                           */
SBIT (P3_3, SFR_P3, 3);             /* Port 3 Bit 3                           */
SBIT (P3_2, SFR_P3, 2);             /* Port 3 Bit 2                           */
SBIT (P3_1, SFR_P3, 1);             /* Port 3 Bit 1                           */
SBIT (P3_0, SFR_P3, 0);             /* Port 3 Bit 0                           */
...
/* Si1020 EZRadioPRO Internal Register */
...
#endif                                /* #define __SI1020_DEFS_H__           */